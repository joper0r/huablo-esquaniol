...
subjects = ['Horror','Adventure','Action','Science+Fiction','Fantasy', 'Mystery', 'Thrillers', 'Science', 'Technology', 'Computers', 'Internet', 'Politics', 'History', 'Romance', 'Sports']
...
for subject in subjects:
    ...
    for item in response.get('items'):
        ...
        book['categories'] = item.get('volumeInfo').setdefault('categories',[])
